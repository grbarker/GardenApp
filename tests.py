...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow_plants(self):
        ...
        # create four plants
        now = datetime.utcnow()
        p1 = Plant(body="plant from john", author=u1,
                  timestamp=now + timedelta(seconds=1))
        p2 = Plant(body="plant from susan", author=u2,
                  timestamp=now + timedelta(seconds=4))
        p3 = Plant(body="plant from mary", author=u3,
                  timestamp=now + timedelta(seconds=3))
        p4 = Plant(body="plant from david", author=u4,
